...
static std::vector<std::unique_ptr<test_case>> make_test_cases_perf() {
    ...
    //>                                                                                   3rd dim  4th dim
    // test_cases.emplace_back(new test_mul_mat(GGML_TYPE_F32, GGML_TYPE_F32, 3200, 1, 3200, { 1,  1}, {1, 1}));
    // test_cases.emplace_back(new test_mul_mat(GGML_TYPE_Q4_0, GGML_TYPE_F32, 3200, 1, 3200, { 1,  1}, {1, 1}));
...
int main(int argc, char ** argv) {
    ...
    const char * backend_filter = "CUDA0";
