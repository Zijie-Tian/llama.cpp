...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_QLUTATTN_K1_128x128] = {
        ...
        .vec_dot_f16              = (ggml_vec_dot_f16_t) ggml_vec_dot_qlutattn_kv1_128x128,  //> Fake
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_QLUTATTN_K2_128x128] = {
        .from_float               = quantize_block_qlutattn_k2_128x128,
        .vec_dot_f16              = (ggml_vec_dot_f16_t) ggml_vec_dot_qlutattn_kv2_128x128,  //> Fake
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    ...
    [GGML_TYPE_QLUTATTN_V1_128x128] = {
        ...
        .vec_dot_f16              = (ggml_vec_dot_f16_t) ggml_vec_dot_qlutattn_kv1_128x128,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_QLUTATTN_V2_128x128] = {
        .from_float               = quantize_block_qlutattn_v2_128x128,
        .vec_dot_f16              = (ggml_vec_dot_f16_t) ggml_vec_dot_qlutattn_kv2_128x128,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
...
static void ggml_compute_forward_mul_mat(
    ...
    //> [reduce_axis, ne01, ne02, ne03] x [reduce_axis, ne11, ne12, ne13] -> [ne01, ne11, ne12, ne13]
