...
void lut_ctor_int8_g4(void * B, void * LUT_Scales, void * LUT_Biases, void * QLUT, int K,
                      const struct tmac_kernel_config * const kernel_config) {
    ...
    for (int32_t kk_outer = 0; kk_outer < kk_outer_max; ++kk_outer) {
        ...
        for (int32_t k_outer = 0; k_outer < act_group_size / 32; ++k_outer) {
            partial_max_g4_int8_k8((&(((tmac_float_type *) LUT_Scales)[kk_outer])),
