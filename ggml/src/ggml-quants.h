...
GGML_API void quantize_row_qlutattn_w1g128_pg_ref(const float * GGML_RESTRICT           x,
                                                  block_qlutattn_w1g128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_qlutattn_w2g128_pg_ref(const float * GGML_RESTRICT           x,
                                                  block_qlutattn_w2g128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_qlutattn_w4g128_pg_ref(const float * GGML_RESTRICT           x,
                                                  block_qlutattn_w4g128 * GGML_RESTRICT y, int64_t k);

GGML_API void quantize_block_qlutattn_k1_128x128_ref(const float * GGML_RESTRICT                x,
                                                     block_qlutattn_kv1_128x128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_block_qlutattn_k2_128x128_ref(const float * GGML_RESTRICT                x,
                                                     block_qlutattn_kv2_128x128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_block_qlutattn_k4_128x128_ref(const float * GGML_RESTRICT                x,
                                                     block_qlutattn_kv4_128x128 * GGML_RESTRICT y, int64_t k);

GGML_API void quantize_block_qlutattn_v1_128x128_ref(const float * GGML_RESTRICT                x,
                                                     block_qlutattn_kv1_128x128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_block_qlutattn_v2_128x128_ref(const float * GGML_RESTRICT                x,
                                                     block_qlutattn_kv2_128x128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_block_qlutattn_v4_128x128_ref(const float * GGML_RESTRICT                x,
                                                     block_qlutattn_kv4_128x128 * GGML_RESTRICT y, int64_t k);
//> ===================================================================================================
//> Dequantization
//> ===================================================================================================
...
GGML_API void dequantize_row_qlutattn_w1g128(const block_qlutattn_w1g128 * GGML_RESTRICT x, float * GGML_RESTRICT y,
                                             int64_t k);
GGML_API void dequantize_row_qlutattn_w2g128(const block_qlutattn_w2g128 * GGML_RESTRICT x, float * GGML_RESTRICT y,
                                             int64_t k);
GGML_API void dequantize_row_qlutattn_w4g128(const block_qlutattn_w4g128 * GGML_RESTRICT x, float * GGML_RESTRICT y,
                                             int64_t k);

//> ===================================================================================================
//> Quantization utilizing an importance matrix (a.k.a. "Activation aWare Quantization")
//> ===================================================================================================
GGML_API size_t quantize_iq2_xxs(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                                 int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq2_xs(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                                int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq2_s(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                               int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq3_xxs(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                                 int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq1_s(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                               int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq1_m(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                               int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq4_nl(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                                int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq4_xs(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                                int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq3_s(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                               int64_t n_per_row, const float * imatrix);

GGML_API size_t quantize_tq1_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                               int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_tq2_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                               int64_t n_per_row, const float * imatrix);

GGML_API size_t quantize_q2_K(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q3_K(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q4_K(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q5_K(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q6_K(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q4_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q4_1(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q5_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q5_1(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q8_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q8_1(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows,
                              int64_t n_per_row, const float * imatrix);
